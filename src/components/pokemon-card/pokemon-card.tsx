        ...
        <div className="pokemon-card" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="pokemon-main-info">
              ...
              {pokemon.image.map((image) => (
                <div key={image.url} className="pokemon-image-wrapper">
                  {image.url ? (
                    ...
                    <div style={{ color: "black" }}>No {image.type} image</div>
                  )}
                </div>
              ))}
            </div>
            ...
            <div>
              <p>
                Weight:{" "}
                <span className="pokemon-weight">{pokemon.weight / 10} kg</span>
              </p>
              <p>
                Height:{" "}
                <span className="pokemon-height">{pokemon.height * 10} sm</span>
              </p>
